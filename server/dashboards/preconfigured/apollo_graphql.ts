...
export const config: IDashboardConfig = /*return*/ {
  ...
  html: `<div>
	...
	config: {
		connections: {
			"application-insights": { appId: "4d567b3c-e52c-4139-8e56-8e573e55a06c",apiKey: "o27hgbeqnkodr7ttcqs061z4bfxuyak4t0mvp8h1" }
		},
		layout: {
			isDraggable: true,
			isResizable: true,
	...
	visual: [
		...
		{ Type: "PieData",query: "predefined_pie1",title: "Pie title",subtitle: "Dynamic Subtitle for pie" },
		{
			Type: "BarChart",
	...
	visualFilters: [{ Type: "DropDown",query: "predefined_channels1",title: "MyDropDownTitle",id: "channelsFilter1" }],
	visualDialog: [
		{
			Type: "Dialog",
			id: "dialog2",
			visual: [
				{ Type: "PieData",query: "predefined_pie1",title: "Pie title",subtitle: "Dynamic Subtitle for pie" },
				{ Type: "LineChart",query: "predefined_users_timeline1",title: "MyDynamicTitle",filters: "channelsFilter1" }
			]
		},
		{ Type: "Dialog",id: "dialog1",visual: [{ Type: "LineChart",query: "predefined_users_timeline2",title: "papa" }] }
	]
}